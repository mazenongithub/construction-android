...
import { CreateBidScheduleItem, DirectCostForLabor, DirectCostForMaterial, DirectCostForEquipment, sorttimes, ProfitForLabor, ProfitForMaterial, ProfitForEquipment, isNumeric, UTCTimefromCurrentDate, UTCStringFormatDateforProposal, inputUTCStringForLaborID } from './functions'
...
class ViewInvoice {
    getinvoice() {
        ...
        const invoices = construction.getinvoicesbyprojectid.call(this, projectid)
        ...
        return (
            <View style={[styles.generalFlex]}>
                <View style={[styles.generalFont, headerFont, styles.flex1]}>
                    ...
                    <View style={[styles.generalFlex]}>
                        <View style={[styles.generalFont, styles.flex1]}><Text style={[regularFont]}>Calculated Invoice Amount is ${amount} Total amount of Transfers is ${sumoftransfers} Total Amount left to be paid out ${invoicebalance} </Text></View>
                    </View>
