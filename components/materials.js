...
class Materials extends Component {
    constructor(props) {
        super(props)
        this.state = this.state = { render: '', accountname: '', activematerialid: '', materialid: '', material: '', accountid: '', unit: '', unitcost: '', message: '', width:0, height:0}
    ...
    render() {
        ...
        if (myuser) {
            if (checkmanager) {
                    ...
                    <View style={[styles.flex1]}>
                        ...
                        <View style={[styles.generalFlex, styles.bottomMargin10]}>
                            <View style={[styles.flex1]}>
                                ...
                                <Text style={[headerFont, styles.alignCenter, styles.boldFont]}>/materials</Text>
                            </View>
                        </View>
                ...
                return (<Text style={[regularFont]}>Only Managers can view Material Component </Text>)
            }
        } else {
