...
import { calculatetotalhours, inputUTCStringForLaborID, inputUTCStringForMaterialIDWithTime, inputDateObjOutputAdjString, CreateProposal, isNumeric, UTCTimefromCurrentDate, UTCStringFormatDateforProposal } from './functions'
            ...
            return (
                <View style={[styles.generalFlex, styles.bottomMargin10, proposals.activebackground.call(this, item.proposalid)]} key={item.laborid}>
                    <View style={[styles.flex2, styles.flexDirection]}>
                        ...
                        <TextInput style={{...styles.smallField}} value={laborrate} onChangeText={text => { proposals.handlelaborrate.call(this, text, item.laborid) }} style={[regularFont, styles.defaultInput, styles.smallField]} />
                    ...
                    <View style={[styles.flex1]}>
                        ...
                        <TextInput style={[regularFont, styles.defaultInput,styles.smallField]} onChangeText={text => { proposals.handlelaborprofit.call(this, text, item.laborid) }} value={item.profit.toString()} />
                    </View>
            ...
            return (
                <View style={[styles.generalFlex, styles.bottomMargin10, proposals.activebackground.call(this, item.proposalid)]} key={item.laborid}>
                    ...
                    <View style={[styles.flex1]}>
                        ...
                        <TextInput style={[regularFont, styles.defaultInput,styles.smallField]} value={item.profit.toString()} onChangeText={text => { proposals.handlelaborprofit.call(this, text, item.laborid) }} />
                    </View>
        ...
        if (menu.open) {
            return (
                <View style={[styles.generalFlex, styles.bottomMargin10, proposals.activebackground.call(this, item.proposalid)]} key={item.equipmentid}>
                    ...
                    <View style={[styles.flex1]}>
                        <Text style={[regularFont]} onPress={() => { proposals.addItem.call(this, item) }}>Profit</Text>
                        <TextInput style={[regularFont, styles.defaultInput,styles.smallField]} value={item.profit.toString()} onChangeText={text => { proposals.handleequipmentprofit.call(this, text, item.equipmentid) }} />
                    </View>
        ...
        if (menu.open) {
            return (
                <View style={[styles.generalFlex, styles.bottomMargin10, proposals.activebackground.call(this, item.proposalid)]} key={item.materialid}>
                    ...
                    <View style={[styles.flex1]}>
                        <Text style={[regularFont]} onPress={() => { proposals.addItem.call(this, item) }}>Profit</Text>
                        <TextInput style={[regularFont, styles.defaultInput,styles.smallField]} value={item.profit} onChangeText={text => { proposals.handlematerialprofit.call(this, text, item.materialid) }} />
                    </View>
