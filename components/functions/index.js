...
export function DatePickerDisplay(timein) {
...
export function DateObjfromTimeString(timein) {
    ...
    return (new Date(`${timein.replace(/-/g, '/')}${sym}${offset}:00`))
}
export function DateobjfromUTCString(timein) {

    return (new Date(`${timein.replace(/-/g, '/')}-00:00`))
}
...
export function DateCalendarDisplay(timein) {
    //let timein = new Date();
    ...
    let dayofweek = timein.getDay();
    let month = timein.getMonth() + 1;
    let day = timein.getDate();
    let year = timein.getFullYear();
    return (`${getDay(dayofweek)} ${getMonth(month)} ${day} ${year}`)
}
export function DateDisplayfromObj(timein) {
    ...
    let month = timein.getMonth();
    month = month + 1;
    let Month = getMonth(month)
    let day = timein.getDate();
    let year = timein.getFullYear();
    return (`${getDay()} ${Month} ${day} ${year}  ${hours}:${minutes} ${ampm}`)
}
...
export function decreasedatebyoneday(timein) {
    // let timein = '2020-03-01';
    let offset = getOffset(timein);
    let datein = new Date(`${timein.replace(/-/g, '/')} 00:00:00${offset}`);
...
export function inputUTCStringOutputObj(timein) {
