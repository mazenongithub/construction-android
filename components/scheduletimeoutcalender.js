...
class CalenderTimeOut {
    ...
    showCalender() {
        ...
        const firstofmonth = getFirstIsOnTime(timeout);
        const check29 = check_29_feb_leapyear_time(timeout);
        const check30 = check_30_time(timeout);
        const check31 = check_31_time(timeout);
...
export default CalenderTimeOut;