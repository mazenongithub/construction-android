...
class Equipment extends Component {
    ...
    handleloaninterest(loaninterest) {
        ...
        alert(`Loan interest should be numeric`)
    }
                    ...
                    return (
                        <View style={[styles.generalFlex, styles.bottomMargin10]}>
                            <View style={[styles.flex1]}>
                                ...
                                <View style={[styles.generalFlex, styles.bottomMargin10]}>
                                    <View style={[styles.flex1]}>
                                        <Text style={[headerFont, styles.alignCenter]}>Ownership</Text>
                                    </View>
                                </View>
                                {workinghours()}
                            </View>
   ...
   handledetail(detail) {
    ...
    showcostid(cost) {
        ...
        const remove = () => {
            return( <TouchableOpacity onPress={() => { this.removeequipmentcost(cost) }}>
            <Image source={require('./png/removeIcon.png')}
                style={removeIconSize}
                resizeMethod='scale'
            />
    ...
    ownershipdetail() {
        ...
        const dateofcost = () => {
            if(this.state.activecostid) {
                ...
                <View style={[styles.generalFlex, styles.bottomMargin10]}>
                    <View style={[styles.flex1]}>
                        <Text style={[regularFont]}>Date of Cost</Text>
                    ...
                    return (
                        <View style={[styles.generalFlex]}>
                            <View style={[styles.flex1]}>
                                ...
                                <View style={[styles.generalFlex, styles.bottomMargin10]}>
                                    <View style={[styles.flex1]}>
                                        <Text style={[headerFont, styles.alignCenter]}>Ownership Costs </Text>
                                    </View>
                                </View>
    ...
    handleaccountid(accountid) {
        ...
        if (myuser) {
            ...
            alert(`Only Managers can update equipment accounts `)
        }
