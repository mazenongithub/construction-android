...
import { CreateBenefit, isNumeric  } from './functions';
...
class Employees extends Component {
    ...
    handleworkinghours(workinghours) {
        ...
        if(isNumeric(workinghours)) {
            ...
            alert(`Working hours should be numeric`)
        }
        } else {
            alert(`Only Managers can update employee working hours`)
        }
    }
    ...
    handlebenefit(benefit) {
        ...
        alert(`Only Managers can update employee benefits `)
        }
    } 
    ...
    handleamount(amount) {
        ...
        if(isNumeric(amount)) {
            ...
            alert(`Only Managers can update benefit amount`)
        }
...
showemployeebenefit(benefit) {
    ...
    if (menu.open) {
        return (
            <View style={[styles.generalFlex, styles.bottomMargin10, activebenefit()]} key={benefit.benefitid}>
        ...
        return (<View style={[styles.generalFlex,activebenefit()]} key={benefit.benefitid}>
            <View style={[styles.flex4]}>
                <Text style={[regularFont]} onPress={() => { this.makebenefitactive(benefit.benefitid) }}> {benefit.benefit}  Account:  {account.account} {account.accountname} Amount: {benefit.amount}</Text>
            </View>
            <View style={[styles.flex1]}>
                {remove()}
            </View>
...
render() {
    ...
    const hourlyrate = () => {
        ...
        let hourlyrate = 0;
        if(this.state.activeemployeeid) {
            const myuser = construction.getemployeebyid.call(this,this.state.activeemployeeid)
    ...
    const Employee = () => {
        return( <View style={[styles.generalFlex]}>
            <View style={[styles.flex1]}>
                ...
                <View style={[styles.generalFlex, styles.bottomMargin10]}>
                    <View style={[styles.flex1]}>
                        <Text style={[styles.alignCenter, headerFont, styles.boldFont]}>/{myuser.company.url}</Text>
                        <Text style={[styles.alignCenter, headerFont, styles.boldFont]}>/employees</Text>
                    </View>
                </View>
