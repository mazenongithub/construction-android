...
import { calculatetotalhours, inputUTCStringForLaborID, inputUTCStringForMaterialIDWithTime, CreateInvoice, inputDateObjOutputAdjString, isNumeric, UTCStringFormatDateforProposal } from './functions'
            ...
            if (menu.open) {
                return (
                    <View style={[styles.generalFlex, styles.bottomMargin10, invoices.activebackground.call(this, item.invoiceid)]} key={item.laborid}>
                        <View style={[styles.flex2, styles.flexDirection]}>
                            ...
                            <TextInput style={{...styles.smallField}} value={laborrate} onChangeText={text => { invoices.handlelaborrate.call(this, text, item.laborid) }} style={[regularFont, styles.defaultInput, styles.smallField]} />
                        ...
                        <View style={[styles.flex1]}>
                            ...
                            <TextInput style={[regularFont, styles.defaultInput,styles.smallField]} value={item.profit.toString()} onChangeText={text => { invoices.handlelaborprofit.call(this, text, item.laborid) }} />
                        </View>
                ...
                return (
                    <View style={[styles.generalFlex, styles.bottomMargin10, invoices.activebackground.call(this, item.invoiceid)]} key={item.laborid}>
                        ...
                        <View style={[styles.flex1]}>
                            <Text style={[regularFont]} onPress={() => { invoices.addItem.call(this, item) }}>Profit</Text>
                            <TextInput style={[regularFont, styles.defaultInput, styles.smallField]} value={item.profit} onChangeText={text => { invoices.handlelaborprofit.call(this, text, item.laborid) }} />
                        </View>
            ...
            if (menu.open) {
                return (
                    <View style={[styles.generalFlex, styles.bottomMargin10, invoices.activebackground.call(this, item.invoiceid)]} key={item.equipmentid}>
                        ...
                        <View style={[styles.flex1]}>
                            <Text style={[regularFont]} onPress={() => { invoices.addItem.call(this, item) }}>Profit</Text>
                            <TextInput style={[regularFont, styles.defaultInput,styles.smallField]} value={item.profit.toString()} onChangeText={text => { invoices.handleequipmentprofit.call(this, text, item.equipmentid) }} />
                        </View>
            ...
            if (menu.open) {
                return (
                    <View style={[styles.generalFlex, styles.bottomMargin10, invoices.activebackground.call(this, item.invoiceid)]} key={item.materialid}>
                        ...
                        <View style={[styles.flex1]}>
                            <Text style={[regularFont]} onPress={() => { invoices.addItem.call(this, item) }}>Profit</Text>
                            <TextInput style={[regularFont, styles.defaultInput,styles.smallField]} value={item.profit.toString()} onChangeText={text => { invoices.handlematerialprofit.call(this, text, item.materialid) }} />
                        </View>
                ...
                return (
                    <View style={[styles.generalFlex, styles.bottomMargin10, invoices.activebackground.call(this, item.invoiceid)]} key={item.materialid}>
                        ...
                        <View style={[styles.flex1]}>
                            <Text style={[regularFont]}>Profit</Text>
                            <TextInput style={[regularFont, styles.defaultInput,styles.smallField]} value={item.profit} onChangeText={text => { invoices.handlematerialprofit; call(this, text, item.materialid) }} />
                        </View>
