...
import { getDayfromDateString, dateStringFromUTCTime, scheduleBox, inputUTCStringForLaborID } from './functions'
            ...
            schedules.map(schedule => {
                ...
                if (
                    ...
                    if (dateStringFromUTCTime(schedule.timeout) === dateStringFromUTCTime(schedule.timein)) {
                        ...
                        <View>
                        <Text style={{...regularFont}}>{inputUTCStringForLaborID(schedule.timein)}-{inputUTCStringForLaborID(schedule.timeout)} {project.title} {csi.csi} {csi.title} </Text>
                        </View>
