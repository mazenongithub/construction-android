...
class ViewAccount {
    ...
    showaccount() {
                    ...
                    return (
                        <View style={[styles.generalFlex]}>
                            <View style={[styles.flex1]}>
                                ...
                                <View style={[styles.generalFlex, styles.bottomMargin10]}>
                                    <View style={[styles.flex1]}>
                                        <Text style={[regularFont,styles.blueLink]} onPress={()=>{viewaccount.opendashboard.call(this,account.stripedashboard)}}>{account.stripedashboard} </Text>
                                    </View>
                                </View>
                            ...
                            <View style={[styles.flex1]}>
                                ...
                                <View style={[styles.generalFlex, styles.bottomMargin10]}>
                                    <View style={[styles.flex1]}>
                                        ...
                                        <Text style={[headerFont, styles.alignCenter, styles.boldFont]}>{accountname}</Text>
                                    </View>
                                </View>
        ...
        return(<View><Text style={{...regularFont}}>Your have to be logged in to view accounts</Text></View>)
