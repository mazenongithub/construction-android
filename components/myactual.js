...
class MyActual extends Component {
    ...
    getschedule() {
        ...
        const myschedule = construction.getactuallaborbyproviderid.call(this, myemployee.providerid);
        return myschedule;
    }
    render() {
        ...
        if (myuser) {
                    ...
                    <View style={{ ...styles.flex1, ...styles.alignCenter }}>
                        ...
                        <View style={{ ...styles.generalFlex }}>
                            <View style={{ ...styles.flex1 }}>
                                ...
                                <Text style={{ ...styles.generalFont, ...headerFont, ...styles.boldFont, ...styles.alignCenter}}>View Actual</Text>
                            </View>
            ...
            return (
                <View style={{ ...styles.generalContainer }}>
                    <Text style={{ ...styles.generalFont, ...regularFont }}> Please Login to View Actual</Text>
                </View>)
        }
